                ...
                <ul class="menu">
                    ...
                    <li>
                        ...
                        <div class="submenu" id="qltlSubmenu">
                            <ul>
                            <li><a href="#" onclick="loadPage('bangluong.php')">Bảng lương</a></li>
                            <li><a href="#" onclick="loadPage('capnhatluong.php')">Cập nhật hồ sơ</a></li>
                            <li><a href="#" onclick="loadPage('timkiemluong.php')">Tìm kiếm</a></li>
                            <li><a href="#" onclick="loadPage('tinhluong.php')">Tính lương</a></li>
                            <li><a href="#" onclick="loadPage('tinhthuong.php')">Tính thưởng</a></li>
